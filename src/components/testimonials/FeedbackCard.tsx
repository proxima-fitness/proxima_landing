...
const FeedbackCard = ({ content, name, title, img }: any) => (
  ...
  >
    ...
    <p className="font-main font-normal text-[16px] leading-[32.4px] text-white py-4">
      {content}
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        <h4 className="font-main font-semibold text-[20px] leading-[32px] text-white">
          {name}
        </h4>
        <p className="font-main font-normal text-[16px] leading-[24px] text-dimWhite">
          {title}
        </p>
      </div>
    </div>
