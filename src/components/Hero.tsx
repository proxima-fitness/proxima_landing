      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`} data-aos="fade-up"
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            The #1 Free <br className="sm:block hidden" />{" "}
            <span className="text-gradient">Lifting App</span>{" "}
          </h1>
          <motion.div 
            whileHover={{ scale: 1.2 }}
            whileTap={{ scale: 0.9 }}
        ...
        <span className="text-white">Instagram</span> for your Personal Records.<p></p><p></p>Build, share and track <span className="text-white">personalized workouts</span>. 
        </p>
      </div>
